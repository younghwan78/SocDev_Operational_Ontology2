...
> 상태: v1.1 (2026-07-06 — Stage 16 UI 개편 삽입으로 재번호화, v1.0 대비 구 16~19가 17~20)
...
| L12 | 반응형/접근성 미검증 (데스크톱 1500px 기준), 값 도메인 코드 노출·URL 상태 미반영 등 UI 부채 | 파일럿 사용자 경험 (설득력 저하) | Stage 16 (상세: `06_stage16_ui_overhaul.md`) |
...
- UI 개편(16)은 워크숍 UX 피드백(13)과 실데이터 규모(15)를 반영해 **파일럿(17) 직전**에
  완성한다 — "UI가 설득의 핵심"(03_course_correction §1).
