...
MAPPINGS: dict[str, IngestMapping] = {
    ...
    "kpi_observations": IngestMapping(
        # P3 KPI 시계열 (16_digital_twin_followups.md §4) — 주차별 수치 관측 반입.
        name="kpi_observations",
        label_ko="KPI 관측",
        target_collection="kpi_observations",
        column_map={
            "관측 ID": "id",
            "프로젝트 ID": "project_id",
            "KPI ID": "kpi_id",
        ...
        list_columns={"notes": ";"},
        int_columns={"week"},
        required_columns={"관측 ID", "프로젝트 ID", "KPI ID", "주차", "값"},
        label_domains={"measurement_stage": "measurement_stage"},
        ref_checks={
            "project_id": "projects",
            "kpi_id": "kpi_definitions",
            "scenario_id": "scenarios",
        },
        linkage_fields=("kpi_id", "scenario_id"),
    ),
