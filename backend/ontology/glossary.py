...
VALUE_LABELS: dict[str, dict[str, str]] = {
    ...
    "role": {
        "product_planning": "상품기획",
        "soc_architecture": "SoC 아키텍처",
        "system_engineering": "시스템 엔지니어링",
        "hw_development": "HW 개발",
        "sw_development": "SW 개발",
        "pm": "PM",
        "management": "경영",
    },
    "evidence_type": {
        "architecture_review_note": "아키텍처 검토 노트",
        "architecture_prediction": "아키텍처 예측",
        "bandwidth_estimation": "대역폭 추정",
        "competitor_measurement": "경쟁사 실측",
        "confluence_decision_note": "Confluence 결정 노트",
        "current_measurement": "현 시점 실측",
        "current_project_measurement": "현 프로젝트 실측",
        "customer_feedback": "고객 피드백",
        "dump": "덤프",
        "emulator_functional_result": "에뮬레이터 기능 결과",
        "field_log": "필드 로그",
        "lab_trace": "랩 트레이스",
        "power_dashboard": "전력 대시보드",
        "prediction_model": "예측 모델",
        "previous_project_measurement": "이전 프로젝트 실측",
        "regression_result": "회귀 결과",
        "rtl_area_estimate": "RTL 면적 추정",
        "sw_power_unknown": "SW 전력 미상",
        "thermal_report": "Thermal 리포트",
    },
    "support_status": {
        "supported": "지원",
        "conditional": "조건부 지원",
